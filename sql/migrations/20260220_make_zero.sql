-- Migration: Add MAKE_ZERO to rotation, duration, stats
...
CHECK (game_type IN (
    ...
    'MEMORY', 'SEQUENCE', 'SEQUENCE_NORMAL', 'LARGEST',
    'PAIR', 'UPDOWN', 'SLIDER', 'ARROW', 'NUMBER_DESC',
    'BLANK', 'OPERATOR', 'LADDER', 'TAP_COLOR',
    'AIM', 'MOST_COLOR', 'SORTING', 'SPY',
    'PATH', 'BLIND_PATH', 'BALLS', 'CATCH_COLOR',
    'TIMING_BAR', 'COLOR_TIMING', 'STAIRWAY', 'MAKE_ZERO'
));

-- 2. Update game duration: MAKE_ZERO = 40초
...
-- 3. Update stat increments (rebalanced 5-point values + MAKE_ZERO)
...
-- 4. Update start_game: add MAKE_ZERO to rotation pool
...
-- 5. Update start_next_round: add MAKE_ZERO to v_types (matches schema.sql exactly)
