...
export type SoundType = 'click' | 'hover' | 'win' | 'lose' | 'countdown' | 'match_found' | 'tick' | 'bgm_main' | 'error' | 'level_complete';
...
export const SoundProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [sounds, setSounds] = useState<Record<SoundType, Howl | null>>({
        ...
        countdown: null, match_found: null, tick: null, bgm_main: null, error: null, level_complete: null
    });
