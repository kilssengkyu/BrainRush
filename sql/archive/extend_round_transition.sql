-- Extend round transition from 4 seconds to 6 seconds
-- This allows: 3s "Round Finished" + 3s "Game Description" between rounds
-- Uses get_game_duration() for per-game duration (from add_game_duration.sql)
