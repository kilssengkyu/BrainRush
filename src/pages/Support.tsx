...
const Support = () => {
    ...
    return (
        <div className={`min-h-[100dvh] relative overflow-x-hidden overflow-y-auto flex flex-col items-center p-6 pt-[calc(env(safe-area-inset-top)+1.5rem)] pb-12 bg-slate-50 dark:bg-gray-950 text-slate-900 dark:text-white`}>
            ...
            <main className="w-full max-w-2xl z-10 space-y-6 text-sm leading-relaxed text-slate-700 dark:text-gray-200">

                {/* Contact Section */}
                <section className="bg-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/10 space-y-3">
                    <div className="flex items-center gap-2 mb-2">
                        <Mail size={20} className="text-emerald-400" />
                        <h2 className="text-base font-semibold text-slate-900 dark:text-white">Contact Us / 문의하기</h2>
                    </div>
                    <p>If you have any questions, issues, or feedback, please contact us via email.</p>
                    <p>질문, 문제, 또는 피드백이 있으신 경우 아래 이메일로 연락해 주세요.</p>
                    <a
                        href="mailto:brainrush.help@gmail.com"
                        className="inline-flex items-center gap-2 mt-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-500 rounded-xl font-semibold text-slate-900 dark:text-white transition-colors active:scale-95"
                    >
                        <Mail size={16} />
                        brainrush.help@gmail.com
                    </a>
                    <p className="text-slate-500 dark:text-gray-400 text-xs mt-2">We typically respond within 48 hours. / 보통 48시간 이내에 답변 드립니다.</p>
                </section>
                ...
                <section className="space-y-3">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h2 className="text-base font-semibold text-slate-900 dark:text-white">FAQ / 자주 묻는 질문</h2>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-md rounded-xl p-4 border border-white/10 space-y-2">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="font-semibold text-slate-900 dark:text-white">How do I play?</p>
                        </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-md rounded-xl p-4 border border-white/10 space-y-2">
                        <div className="flex items-center gap-2">
                            <MessageCircle size={16} className="text-emerald-400 shrink-0" />
                            <p className="font-semibold text-slate-900 dark:text-white">How do I delete my account?</p>
                        </div>
                        <p className="pl-6 text-slate-600 dark:text-gray-300">
                    ...
                    <div className="bg-white/5 backdrop-blur-md rounded-xl p-4 border border-white/10 space-y-2">
                        <div className="flex items-center gap-2">
                            <MessageCircle size={16} className="text-emerald-400 shrink-0" />
                            <p className="font-semibold text-slate-900 dark:text-white">I made a purchase but didn't receive the item.</p>
                        </div>
                        <p className="pl-6 text-slate-600 dark:text-gray-300">
                    ...
                    <div className="bg-white/5 backdrop-blur-md rounded-xl p-4 border border-white/10 space-y-2">
                        <div className="flex items-center gap-2">
                            <MessageCircle size={16} className="text-emerald-400 shrink-0" />
                            <p className="font-semibold text-slate-900 dark:text-white">The game is lagging or not loading.</p>
                        </div>
                        <p className="pl-6 text-slate-600 dark:text-gray-300">
                ...
                <section className="bg-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/10 space-y-3">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h2 className="text-base font-semibold text-slate-900 dark:text-white">Report a Problem / 문제 신고</h2>
                    </div>
                ...
                <section className="bg-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/10 space-y-3">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h2 className="text-base font-semibold text-slate-900 dark:text-white">Privacy Policy / 개인정보 처리방침</h2>
                    </div>
                    <p>
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-xl font-semibold text-slate-900 dark:text-white transition-colors active:scale-95"
                    >
                        View Privacy Policy
                    </button>
                </section>
