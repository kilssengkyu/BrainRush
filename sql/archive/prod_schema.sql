...
\restrict kRNYQ2N67iC0OmtVc24V9epN9x2ppRpWS9bcpCKd7aWuy2SRfZl2e7WpulwTNqf
...
--
-- Name: cancel_friendly_session(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.cancel_friendly_session(p_room_id uuid) OWNER TO postgres;

--
-- Name: check_active_session(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.check_active_session(p_player_id text) OWNER TO postgres;

--
-- Name: consume_pencil(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.consume_pencil(user_id uuid) OWNER TO postgres;

--
-- Name: create_bot_session(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_bot_session(p_player_id text) OWNER TO postgres;

--
-- Name: create_practice_session(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_practice_session(p_player_id text, p_game_type text) OWNER TO postgres;

--
-- Name: create_session(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_session(p_player1_id text, p_player2_id text) OWNER TO postgres;
...
--
-- Name: find_match(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer) OWNER TO postgres;

--
-- Name: find_match(integer, integer, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text) OWNER TO postgres;

--
-- Name: find_match(integer, integer, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text, p_mode text) OWNER TO postgres;

--
-- Name: finish_game(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.finish_game(p_room_id uuid) OWNER TO postgres;

--
-- Name: get_leaderboard(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_leaderboard(p_user_id uuid) OWNER TO postgres;

--
-- Name: get_player_match_history(uuid, text, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_player_match_history(p_user_id uuid, p_mode text, p_limit integer, p_offset integer) OWNER TO postgres;

--
-- Name: get_profile_with_pencils(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_profile_with_pencils(user_id uuid) OWNER TO postgres;
...
--
-- Name: get_tier_name(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_tier_name(p_mmr integer) OWNER TO postgres;

--
-- Name: grant_ads_removal(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.grant_ads_removal(user_id uuid) OWNER TO postgres;

--
-- Name: grant_pencils(uuid, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.grant_pencils(user_id uuid, amount integer) OWNER TO postgres;

--
-- Name: handle_disconnection(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.handle_disconnection(p_room_id uuid, p_leaver_id text) OWNER TO postgres;
...
--
-- Name: next_round(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.next_round(p_room_id uuid) OWNER TO postgres;

--
-- Name: resolve_round(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.resolve_round(p_room_id uuid) OWNER TO postgres;

--
-- Name: reward_ad_pencils(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.reward_ad_pencils(user_id uuid) OWNER TO postgres;

--
-- Name: set_player_ready(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.set_player_ready(p_room_id uuid, p_player_id text) OWNER TO postgres;
...
ALTER FUNCTION public.start_game(p_room_id uuid) OWNER TO postgres;

--
-- Name: start_next_round(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.start_next_round(p_room_id uuid) OWNER TO postgres;

--
-- Name: stat_increments(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.stat_increments(p_game_type text) OWNER TO postgres;

--
-- Name: submit_move(uuid, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.submit_move(p_room_id uuid, p_player_id text, p_move text) OWNER TO postgres;

--
-- Name: trigger_game_start(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.trigger_game_start(p_room_id uuid) OWNER TO postgres;

--
-- Name: update_last_seen(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: update_mmr(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_mmr(p_room_id uuid) OWNER TO postgres;

--
-- Name: update_score(uuid, text, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_score(p_room_id uuid, p_player_id text, p_score integer) OWNER TO postgres;
...
--
-- Name: game_moves; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: player_highscores; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.player_highscores OWNER TO postgres;
...
--
-- Name: COLUMN profiles.country; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: game_moves game_moves_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: player_highscores player_highscores_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_profiles_mmr; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: game_moves game_moves_room_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: player_game_stats player_game_stats_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: player_highscores player_highscores_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: matchmaking_queue Manage own queue entry; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: game_moves Participants can view moves; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: game_sessions Participants can view sessions; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: game_moves Players can insert own moves; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: bot_profiles Public bot profiles are viewable by everyone; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: game_sessions Users can create their own sessions; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: friendships Users can delete their own friendships; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: friendships Users can insert friendship requests; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: player_game_stats Users can insert own game stats; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: player_highscores Users can insert own highscores; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: chat_messages Users can send messages; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: chat_messages Users can update (mark read) received messages; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: player_game_stats Users can update own game stats; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: player_highscores Users can update own highscores; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: profiles Users can update their own last_seen; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: friendships Users can update their received requests or own friendships; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: player_game_stats Users can view own game stats; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: player_highscores Users can view own highscores; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: bot_profiles; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: game_moves; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: player_game_stats; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.player_game_stats ENABLE ROW LEVEL SECURITY;

--
-- Name: player_highscores; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: objects avatars_delete_own 1oj01fe_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: objects avatars_delete_own 1oj01fe_1; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: objects avatars_insert_own 1oj01fe_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: objects avatars_update_own 1oj01fe_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: objects avatars_update_own 1oj01fe_1; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: FUNCTION cancel_friendly_session(p_room_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.cancel_friendly_session(p_room_id uuid) TO anon;
GRANT ALL ON FUNCTION public.cancel_friendly_session(p_room_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.cancel_friendly_session(p_room_id uuid) TO service_role;


--
-- Name: FUNCTION check_active_session(p_player_id text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.check_active_session(p_player_id text) TO anon;
GRANT ALL ON FUNCTION public.check_active_session(p_player_id text) TO authenticated;
GRANT ALL ON FUNCTION public.check_active_session(p_player_id text) TO service_role;


--
-- Name: FUNCTION consume_pencil(user_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.consume_pencil(user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.consume_pencil(user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.consume_pencil(user_id uuid) TO service_role;


--
-- Name: FUNCTION create_bot_session(p_player_id text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.create_bot_session(p_player_id text) TO anon;
GRANT ALL ON FUNCTION public.create_bot_session(p_player_id text) TO authenticated;
GRANT ALL ON FUNCTION public.create_bot_session(p_player_id text) TO service_role;


--
-- Name: FUNCTION create_practice_session(p_player_id text, p_game_type text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.create_practice_session(p_player_id text, p_game_type text) TO anon;
GRANT ALL ON FUNCTION public.create_practice_session(p_player_id text, p_game_type text) TO authenticated;
GRANT ALL ON FUNCTION public.create_practice_session(p_player_id text, p_game_type text) TO service_role;


--
-- Name: FUNCTION create_session(p_player1_id text, p_player2_id text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.create_session(p_player1_id text, p_player2_id text) TO anon;
GRANT ALL ON FUNCTION public.create_session(p_player1_id text, p_player2_id text) TO authenticated;
GRANT ALL ON FUNCTION public.create_session(p_player1_id text, p_player2_id text) TO service_role;
...
--
-- Name: FUNCTION find_match(p_min_mmr integer, p_max_mmr integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer) TO anon;
GRANT ALL ON FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer) TO authenticated;
GRANT ALL ON FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer) TO service_role;


--
-- Name: FUNCTION find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text) TO anon;
GRANT ALL ON FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text) TO authenticated;
GRANT ALL ON FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text) TO service_role;


--
-- Name: FUNCTION find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text, p_mode text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text, p_mode text) TO anon;
GRANT ALL ON FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text, p_mode text) TO authenticated;
GRANT ALL ON FUNCTION public.find_match(p_min_mmr integer, p_max_mmr integer, p_player_id text, p_mode text) TO service_role;


--
-- Name: FUNCTION finish_game(p_room_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.finish_game(p_room_id uuid) TO anon;
GRANT ALL ON FUNCTION public.finish_game(p_room_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.finish_game(p_room_id uuid) TO service_role;


--
-- Name: FUNCTION get_leaderboard(p_user_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_leaderboard(p_user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.get_leaderboard(p_user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.get_leaderboard(p_user_id uuid) TO service_role;


--
-- Name: FUNCTION get_player_match_history(p_user_id uuid, p_mode text, p_limit integer, p_offset integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_player_match_history(p_user_id uuid, p_mode text, p_limit integer, p_offset integer) TO anon;
GRANT ALL ON FUNCTION public.get_player_match_history(p_user_id uuid, p_mode text, p_limit integer, p_offset integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_player_match_history(p_user_id uuid, p_mode text, p_limit integer, p_offset integer) TO service_role;


--
-- Name: FUNCTION get_profile_with_pencils(user_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_profile_with_pencils(user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.get_profile_with_pencils(user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.get_profile_with_pencils(user_id uuid) TO service_role;
...
--
-- Name: FUNCTION get_tier_name(p_mmr integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_tier_name(p_mmr integer) TO anon;
GRANT ALL ON FUNCTION public.get_tier_name(p_mmr integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_tier_name(p_mmr integer) TO service_role;


--
-- Name: FUNCTION grant_ads_removal(user_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.grant_ads_removal(user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.grant_ads_removal(user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.grant_ads_removal(user_id uuid) TO service_role;


--
-- Name: FUNCTION grant_pencils(user_id uuid, amount integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.grant_pencils(user_id uuid, amount integer) TO anon;
GRANT ALL ON FUNCTION public.grant_pencils(user_id uuid, amount integer) TO authenticated;
GRANT ALL ON FUNCTION public.grant_pencils(user_id uuid, amount integer) TO service_role;


--
-- Name: FUNCTION handle_disconnection(p_room_id uuid, p_leaver_id text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.handle_disconnection(p_room_id uuid, p_leaver_id text) TO anon;
GRANT ALL ON FUNCTION public.handle_disconnection(p_room_id uuid, p_leaver_id text) TO authenticated;
GRANT ALL ON FUNCTION public.handle_disconnection(p_room_id uuid, p_leaver_id text) TO service_role;
...
--
-- Name: FUNCTION next_round(p_room_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.next_round(p_room_id uuid) TO anon;
GRANT ALL ON FUNCTION public.next_round(p_room_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.next_round(p_room_id uuid) TO service_role;


--
-- Name: FUNCTION resolve_round(p_room_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.resolve_round(p_room_id uuid) TO anon;
GRANT ALL ON FUNCTION public.resolve_round(p_room_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.resolve_round(p_room_id uuid) TO service_role;


--
-- Name: FUNCTION reward_ad_pencils(user_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.reward_ad_pencils(user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.reward_ad_pencils(user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.reward_ad_pencils(user_id uuid) TO service_role;


--
-- Name: FUNCTION set_player_ready(p_room_id uuid, p_player_id text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.set_player_ready(p_room_id uuid, p_player_id text) TO anon;
GRANT ALL ON FUNCTION public.set_player_ready(p_room_id uuid, p_player_id text) TO authenticated;
GRANT ALL ON FUNCTION public.set_player_ready(p_room_id uuid, p_player_id text) TO service_role;


--
-- Name: FUNCTION start_game(p_room_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.start_game(p_room_id uuid) TO anon;
GRANT ALL ON FUNCTION public.start_game(p_room_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.start_game(p_room_id uuid) TO service_role;


--
-- Name: FUNCTION start_next_round(p_room_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.start_next_round(p_room_id uuid) TO anon;
GRANT ALL ON FUNCTION public.start_next_round(p_room_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.start_next_round(p_room_id uuid) TO service_role;


--
-- Name: FUNCTION stat_increments(p_game_type text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.stat_increments(p_game_type text) TO anon;
GRANT ALL ON FUNCTION public.stat_increments(p_game_type text) TO authenticated;
GRANT ALL ON FUNCTION public.stat_increments(p_game_type text) TO service_role;


--
-- Name: FUNCTION submit_move(p_room_id uuid, p_player_id text, p_move text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.submit_move(p_room_id uuid, p_player_id text, p_move text) TO anon;
GRANT ALL ON FUNCTION public.submit_move(p_room_id uuid, p_player_id text, p_move text) TO authenticated;
GRANT ALL ON FUNCTION public.submit_move(p_room_id uuid, p_player_id text, p_move text) TO service_role;


--
-- Name: FUNCTION trigger_game_start(p_room_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.trigger_game_start(p_room_id uuid) TO anon;
GRANT ALL ON FUNCTION public.trigger_game_start(p_room_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.trigger_game_start(p_room_id uuid) TO service_role;


--
-- Name: FUNCTION update_last_seen(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION update_mmr(p_room_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.update_mmr(p_room_id uuid) TO anon;
GRANT ALL ON FUNCTION public.update_mmr(p_room_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.update_mmr(p_room_id uuid) TO service_role;


--
-- Name: FUNCTION update_score(p_room_id uuid, p_player_id text, p_score integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.update_score(p_room_id uuid, p_player_id text, p_score integer) TO anon;
GRANT ALL ON FUNCTION public.update_score(p_room_id uuid, p_player_id text, p_score integer) TO authenticated;
GRANT ALL ON FUNCTION public.update_score(p_room_id uuid, p_player_id text, p_score integer) TO service_role;
...
--
-- Name: TABLE game_moves; Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON TABLE public.player_game_stats TO anon;
GRANT ALL ON TABLE public.player_game_stats TO authenticated;
GRANT ALL ON TABLE public.player_game_stats TO service_role;


--
-- Name: TABLE player_highscores; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.player_highscores TO anon;
GRANT ALL ON TABLE public.player_highscores TO authenticated;
GRANT ALL ON TABLE public.player_highscores TO service_role;
...
\unrestrict kRNYQ2N67iC0OmtVc24V9epN9x2ppRpWS9bcpCKd7aWuy2SRfZl2e7WpulwTNqf
