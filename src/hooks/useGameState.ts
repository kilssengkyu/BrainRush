...
export interface GameState {
    ...
    gameType: 'RPS' | 'NUMBER' | 'MATH' | 'MATH_OX' | 'INFINITE_ADD' | 'TEN' | 'COLOR' | 'MEMORY' | 'SEQUENCE' | 'LARGEST' | 'PAIR' | 'UPDOWN' | 'SEQUENCE_NORMAL' | 'NUMBER_DESC' | 'SLIDER' | 'ARROW' | 'BLANK' | 'OPERATOR' | 'LADDER' | 'TAP_COLOR' | 'AIM' | 'MOST_COLOR' | 'SORTING' | 'SPY' | 'PATH' | 'BALLS' | 'BLIND_PATH' | 'CATCH_COLOR' | 'TIMING_BAR' | 'COLOR_TIMING' | 'STAIRWAY' | 'MAKE_ZERO' | 'ONE_STROKE' | null;
    seed: string | null;
    startAt: string | null;
    endAt: string | null;
    myScore: number;
